...
const RAPIDAPI_KEY = import.meta.env.VITE_RAPIDAPI_KEY || '7720103d08msh013bc736f539332p1bbe8djsn18d6a0220625';
...
async function safeGet(path, opts = {}){
    try{
        ...
        return {data:resp.data, rewresponse:resp}
    }
    catch(err){
        console.log('[cricApi] GET error', path , err?.response?.status, err?.message);
